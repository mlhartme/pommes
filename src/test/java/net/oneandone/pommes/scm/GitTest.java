...
public class GitTest {
    ...
    public void path() throws URISyntaxException {
        ...
        git = new Git();
        assertEquals("github.com/pustefix-projects/pustefix-framework", git.directory(GitUrl.create("https://github.com/pustefix-projects/pustefix-framework.git")));
        assertEquals("github.com/mlhartme/maven-active-markdown-plugin", git.directory(GitUrl.create("ssh://git@github.com/mlhartme/maven-active-markdown-plugin.git")));
        // TODO
